      ...
      <div className="projects-wrapper">
        ...
        <div className="project-grid-wrapper">
          {projects.length != 0 ? (
            projects
              .filter((project) => {
                if (searchQuery === "") return project[1];
                else if (
                  project[1].title
                    .toLowerCase()
              ...
              .map((project) => {
                if (selectedCat())
                  return selectedCategories[project[1].category] ? (
                    <ProjectCard project={project[1]} key={project[0]} />
                  ) : null;
            ...
            <div className="empty-project-list">
              <div className="no-projects">No project has been listed yet</div>
              <LoginGithub
                clientId="535147d45c9ed6dd1b45"
                onSuccess={onSuccess}
                onFailure={onFailure}

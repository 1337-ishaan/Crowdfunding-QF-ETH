        ...
        <div className="features__container container container--px">
          <div className="features__text sponsors">
            ...
            <p className="features__paragraph">
              Contribute to the model of funding public goods where a fund from
              governments or philanthropic institutions matches individual
              contributions to a project. <br />
              <br />
              Matching round starts automatically as soon as matching pool hits
              1 ETH (0 for demo).
            </p>
          </div>
          ...
          <div className="features__wrapper sponsors">
            <div className="features__feature feature--1">
              ...
              <button className="hero__cta cta arch spo" onClick={donateEth}>
                Become a sponsor
              </button>
            </div>
          </div>
